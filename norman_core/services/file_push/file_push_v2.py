...
# v1 (file_push.py) used HTTP pairing + raw TCP sockets + HTTP completion (3 steps).
# v2 uses a single gRPC streaming call for the entire upload.


class FilePushV2(metaclass=Singleton):
